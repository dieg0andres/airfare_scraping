...
inputs = {
    ...
    'traveler_count' : 2                # 2 for purchasing fare
    }

params = {
    'freq' : 1,                         # how frequent to get pricing data (1= daily, 2= every other day, 7= 1/wk
    'length period' : 30,               # how many days beyond initial departure date to do price search
    ...
    'threshold' : int(str(sys.argv[4])) # purchase tickets if price below threshold
}
...
payment = {
    'name'  : 'Diego Galindo',     # name
    'num'   : str(sys.argv[5]),    # card num
    'exp_m' : 11,
    'exp_y' : 2024,     # YYYY format
    'code'  : 503,
